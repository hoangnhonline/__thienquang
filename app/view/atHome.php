  <div id="part2">
  		<?php  include "app/view/menungang.php";?>  
  	  <div id="content1"> <?php  include "app/view/slideshow.php";?> </div>
	  <div id="content2"><?php  include "app/view/baimoi.php";//include"menu.php"; ?></div>  
